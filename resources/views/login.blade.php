...
<html lang="en">
  <head>
    ...
    {{-- C:\xampp\htdocs\resume\public\adm\template\assets\vendors\css\vendor.bundle.base.css --}}
    <!-- endinject -->
  ...
  <body>
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                <h3 class="card-title text-center h1 mb-3">Login</h3>
    ...
    <script src="{{asset('adm/template/assets/js/todolist.j')}}"></script>
    <!-- endinject -->
  </body>
</html>